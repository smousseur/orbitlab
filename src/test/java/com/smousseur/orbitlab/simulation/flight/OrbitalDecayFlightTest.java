...
/**
 * <b>PHY-1 / L2 — the drag-on path, flown</b>.
 *
...
class OrbitalDecayFlightTest {
  ...
  /** The geometry of the L0 measurement table, so the numbers are comparable to it. */
  ...
  // ════════════════════════════════════════════════════════════════════════
  // Recorded, never asserted — an input to PHY-2
  // ════════════════════════════════════════════════════════════════════════
