 ...
 * them.
 *
 * <p><b>One flight, on the budget-sized configuration, and that is a decision</b>. MIS-4 flies two
 * because L4 needed a fully loaded impulsive reference for L6; no lot needs one here, and since L3
 * the fully loaded orbiter is not a configuration the product offers — it would carry 800 kg where
 * the budget sizes ~658, changing the mass at injection, the injection and therefore the arrival,
 * without exercising a single mechanism this flight does not. MIS-4's own non-regression stays with
 * {@code LunarFlybyFlightTest}, untouched.
 *
 ...
 * hyperbola.
 *
 * <p><b>Contrainte de méthode</b>: a full CMA-ES ascent plus five days of propagation on both
 * passes, and it is the user who runs it.
 */
...
class LunarOrbitFlightTest {
   ...
   * the sizing whose 10 % margin L4 saw consumed at 3.7 % on a fabricated hyperbola; here it meets
   * a real arrival.
   */
