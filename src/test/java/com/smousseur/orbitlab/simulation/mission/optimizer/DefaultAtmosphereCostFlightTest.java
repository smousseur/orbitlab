 ...
 * L1} measured at ×7.5 on the gravity turn.
 ...
 * routes to the two-pass {@code MeasuredLoadPlanner} of {@code L4} — drag-on against the same
 * mission opted out, and logs the ratio.
 *
