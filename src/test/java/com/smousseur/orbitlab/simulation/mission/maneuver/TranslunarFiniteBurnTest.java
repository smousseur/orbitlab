 ...
 * the lot by.
 *
 * <p><b>It exists because no lunar flight of the repository flies an Ariane 64</b>: the
 ...
 * what a lunar Ariane would additionally need sizing.
 *
 * <p><b>The two profiles fly the same 22.7 t at injection</b>, which is the mass the découpage's
 * duration table is implicitly written at. Flown on 2026-08-27, that mass reproduces the
