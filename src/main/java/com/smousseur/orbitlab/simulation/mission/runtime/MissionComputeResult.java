 ...
 *
 * <p>{@code achievedOrbit} is the orbit at the end of the flown mission, in both the osculating
 * and mean conventions. Reporting only — nothing reads it back into the computation. It is
 * carried on the result rather than merely logged so the UI can display it without recomputing.
 */
