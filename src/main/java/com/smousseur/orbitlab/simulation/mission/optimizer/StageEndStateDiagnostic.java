 ...
 * for the mission's target altitude — see (« État de fin de GT »).
 */
public final class StageEndStateDiagnostic {

  // Off-flight diagnostic, left Earth-fixed by PHY-4 / L1. It reports on a state, it does not fly
  // one, so the L1 seam does not run through it. Wake
