...
final class CircularizationBurnResolver {
  ...
  CircularizationBurnResolver(Vehicle vehicle, FlightContext context) {
  ...
  TransfertTwoManeuver.ResolvedCircularizationBurn resolveCircularizationBurn(
    ...
    double dtApoapsis = detectTimeToApoapsis(stateAfterBurn1, context);
  ...
  private static double detectTimeToApoapsis(
      SpacecraftState stateAfterBurn1, FlightContext context) {
