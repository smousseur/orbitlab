...
public abstract class MissionStage {
   ...
   * late-ignition invariant. The default steps at {@link
   ...
   * pure refactor. L4 is where a stage
   ...
   * oversight: a burn is rebuilt from the stage entry date with its full duration
