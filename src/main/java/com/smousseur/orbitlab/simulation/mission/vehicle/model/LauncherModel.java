 ...
 *     exists. The rendering layer converts it, the propagation ignores it.
 */
public record LauncherModel(
   ...
   * 22.8. Summing the ground-lit stages is the grandeur a reader actually compares between
   * launchers, and it stays right whatever the catalog does to its staging afterwards.
   *
   ...
   * The factor is 1 on every launcher that does not throttle.
   *
