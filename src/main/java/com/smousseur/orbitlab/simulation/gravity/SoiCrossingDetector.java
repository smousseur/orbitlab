 ...
 * its threshold is a constant and ours breathes with the Earth-Moon distance.
 *
 ...
 * moved a margin clear before the reverse crossing counts.
 */
public class SoiCrossingDetector extends AbstractDetector<SoiCrossingDetector> {
   ...
   * physics because the opposite body perturbs on both sides anyway.
   */
