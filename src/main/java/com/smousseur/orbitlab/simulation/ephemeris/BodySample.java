 ...
 *
 * <p>Contains the body's position/velocity coordinates and rotation, both expressed in the ICRF
 ...
 */
public record BodySample(AbsoluteDate date, PVCoordinates pvIcrf, Rotation rotationIcrf) {
  public BodySample {
