...
public final class MissionTimelineWidget implements AutoCloseable {
   ...
   * subscribes to {@code SpeedChanged} — before that change it would have left the
  ...
  /**
   * The distinct terminator of a truncated flight. Without it the track would show a
   ...
   * a single branch instead of a z-order argument, and it costs one pass over a handful of
