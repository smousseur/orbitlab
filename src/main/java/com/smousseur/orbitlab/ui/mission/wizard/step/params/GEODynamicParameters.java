...
public class GEODynamicParameters extends DynamicParameters {
  ...
  public double defaultHorizonDays() {
    // The geostationary altitude is the mission's definition, not a parameter: the derived horizon
    // is the same for every GEO mission, three sidereal days.
    return revolutionDays(
        MissionHorizon.DEFAULT_GEO_REVOLUTIONS,
        Constants.WGS84_EARTH_EQUATORIAL_RADIUS + GEO_ALTITUDE * 1000.0);
  }
