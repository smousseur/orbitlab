...
public class InfoBanner {
  ...
  public InfoBanner(String text, Variant variant) {
    ...
    root.setBackground(UiKit.gradientBackground(MissionWizardStyles.WIZARD_BG_CARD));
    ...
    body.addChild(UiKit.iconPlaceholder(iconPath, 16, 16));

    Label msg = body.addChild(new Label(text, MissionWizardStyles.STYLE));
    msg.setFont(UiKit.mono(12));
