 ...
 *
 * <p>Creates and lays out a {@link MissionPanelWidget} during initialization, updates it each
 * frame to keep the mission list current, and properly closes the widget on cleanup.
 */
