 ...
 *
 * <p>Creates and lays out a {@link TimelineWidget} during initialization, updates it each
 * frame to reflect the current simulation time and playback state, and properly closes
 * the widget on cleanup to release GUI resources.
 */
