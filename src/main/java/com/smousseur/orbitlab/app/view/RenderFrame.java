...
/**
 * Defines how Orekit positions (meters, typically ICRF) are interpreted before scaling to JME
 * units.
 *
...
public enum RenderFrame {
  ...
  /**
   * Positions expressed relative to a target body: r_local = r_object - r_target (still in ICRF
   * axes).
   */
