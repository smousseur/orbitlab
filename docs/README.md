...
| [`navigation/02-timeline-mission.md`](navigation/02-timeline-mission.md) | Design de la timeline de mission indexée sur le temps (widget séparé, marqueurs de phases) | **Rédigé le 2026-08-11**, non commencé (item `NAV-2`) — §15 liste les deux arbitrages pris faute de décision amont |
