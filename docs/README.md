...
| [`menu/01-menu-applicatif.md`](menu/01-menu-applicatif.md) | Propositions pour le menu applicatif haut-gauche (remplace le bouton « Missions ») | **Rédigé le 2026-08-14**, non commencé (item `UI-4`) — trois variantes maquettées sur les assets existants (§4), variante « chip formulaire » recommandée (§5) ; §8 liste trois arbitrages mineurs restants |
