...
| [`navigation/01-breadcrumb.md`](navigation/01-breadcrumb.md) | Design du breadcrumb HUD | **Révisé le 2026-08-12** (périmètre V1 réduit : hiérarchie seule, missions exclues, racine `Solar system` ; dropdown des fils en V2, §7), **non commencé** (item `NAV-4`) |
