...
**Ce que le widget garde tout de même, et il faut être exact.** Deux constantes vivent chez lui : le nombre de marqueurs à montrer, qui est bien une préférence d'affichage — et **la demi-largeur du zoom, 300 s**, qui est une durée terrestre. Le §3 la fixe à ± 5 min, donc elle est assumée ; mais la formule « aucune durée n'est écrite dans le widget » était trop absolue. La règle exacte est plus étroite : le widget ne décide d'aucun **horizon**. L'échelle de son zoom, elle, devra être dérivée du problème le jour où un critère non terrestre atteindra cette page. Au niveau du jour, une opportunité est dessinée comme un **instant** — un marqueur, dont personne n'attend que la largeur signifie quelque chose, donc qui ne ment sur rien. La largeur vraie ne se montre qu'au niveau du zoom, où elle occupe environ 39 % d'un cadre de ± 5 min et redevient l'information qu'elle est : la marge opératoire.
...
| `SELECTED WINDOW` | Le zoom à ± 5 min : l'intervalle ouvert et l'optimum. **Pas de courbe de coût** — Lemur n'a pas de primitive de ligne et un maillage sur mesure serait hors de proportion ici ; les trois nombres de la ligne de lecture portent la même information. |
