...
| [`mission-detail/01-vue-detail.md`](mission-detail/01-vue-detail.md) | Vue détail mission : orbite atteinte, écart à la cible, stages, message d'erreur | Validée le 2026-08-10, **non implémentée** (item `UI-1`) |
